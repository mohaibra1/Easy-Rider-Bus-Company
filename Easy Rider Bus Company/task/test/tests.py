    ...
    def generate(self) -> List[TestCase]:
        return [
            TestCase(stdin='[{"bus_id" : 128, "stop_id" : 1, "stop_name" : "Prospekt Av.", "next_stop" : 3, "stop_type" : "S", "a_time" : "08:12"}, '
                           ...
                           '{"bus_id" : "", "stop_id" : 2, "stop_name" : "Pilotow Street", "next_stop" : 3, "stop_type" : "S", "a_time" : "09:20"}, '
                           ...
                           '{"bus_id" : "512", "stop_id" : 6, "stop_name" : "Sunset Boulevard", "next_stop" : 0, "stop_type" : "S", "a_time" : "08:16"}]',
                     attach=(13, 2, 1, 3, 1, 2, 4)),
            ...
            TestCase(stdin='[{"bus_id" : 128, "stop_id" : 1, "stop_name" : "Fifth Avenue", "next_stop" : 4, "stop_type" : "S", "a_time" : "08:12"}, '
                           ...
                           '{"bus_id" : 256, "stop_id" : 2, "stop_name" : "Pilotow Street", "next_stop" : 3, "stop_type" : "S", "a_time" : "08.13"},  '
                           '{"bus_id" : "", "stop_id" : "", "stop_name" : "Startowa Street", "next_stop" : 8, "stop_type" : "d", "a_time" : "08:16"},  '
    ...
    def check(self, reply: str, result) -> CheckResult:
        ...
        if not re.match(rf'^{query}$', reply.strip()):
            return CheckResult.wrong("A wrong number of bugs was detected. Expected output:\n\n" 
                                     f"Type and field validation: {result[0]} errors\n"
                                     f"bus_id: {result[1]}\n"
                                     f"stop_id: {result[2]}\n"
